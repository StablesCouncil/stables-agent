...
$files = @(
    "c:\Users\Charles\.gemini\antigravity\scratch\Stablesworks_v2\V2\Files\Stables_lockup.png",
    "c:\Users\Charles\.gemini\antigravity\scratch\Stablesworks_v2\V2\Files\SW_LOGO_Stablesworks_S_v1_MASTER (1).png"
)
