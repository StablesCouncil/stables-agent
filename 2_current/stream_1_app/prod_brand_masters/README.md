...
| **`discord_dj_icon_agent_dj_1024.png`** | Council **DJ** icon: starts from **`assets/dj_icon_ai_reference.png`** (full composition in the **same** white plate / circuit style as the agent mark, with a small **music** glyph), letterboxed to a square on **`#0b0f14`**. If the reference file is absent, this file is a copy of the plain export. |
...
2. Save it as **`assets/dj_icon_ai_reference.png`** here (replace the old file).  
3. Run:
