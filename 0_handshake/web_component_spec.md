...
**Markup** (implemented in `dapp/1-showcase/index.html`; see `minidapp_version.md` if paths bump):
...
**Reference**: `1_development/stream_1_app/dapp/1-showcase/index.html` (`.app-section--caption-bottom`, `.stitle-row`, `.agent-mini-btn`, `.app-section-card` in the page `<style>` block).
