...
**Markup** (implemented in `prod_stables_app_v00.00.02/index.html`; see `minidapp_version.md` if the folder bumps):
...
**Reference**: `1_development/stream_1_app/prod_stables_app_v00.00.02/index.html` (`.app-section--caption-bottom`, `.stitle-row`, `.agent-mini-btn`, `.app-section-card` in the page `<style>` block).
