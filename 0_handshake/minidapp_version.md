...
| | |
|--|--|
| **Active development** | `1_development/stream_1_app/prod_stables_app_v0.01.01/` |
| **Executable shell (CSS + pages)** | `prod_stables_app_v0.01.01/index.html` (`<style>` block) |
...
| **Dev zip (v0.01.01)** | `prod_stables_app_v0.01.01/build/Stables.mds.zip` (and `Stables_v0.01.01.mds.zip`) |

**Rules**

- All agent edits go to **`prod_stables_app_v0.01.01`** until the next version bump.
...
**Last bumped**: 2026-03-30 (v0.2.11 → v0.01.01).
