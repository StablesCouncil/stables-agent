...
| | |
|--|--|
| **Active development** | `1_development/stream_1_app/prod_stables_app_v0.2.11/` |
| **Executable shell (CSS + pages)** | `prod_stables_app_v0.2.11/index.html` (`<style>` block) |
...
| **Dev zip (v0.2.11)** | `prod_stables_app_v0.2.11/build/Stables.mds.zip` (and `Stables_v0.2.11.mds.zip`) |

**Rules**

- All agent edits go to **`prod_stables_app_v0.2.11`** until the next version bump.
...
**Last bumped**: 2026-03-23 (v0.2.10 → v0.2.11).
