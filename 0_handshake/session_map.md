...
| `minima_archive_raw_public_export.md` | `2_current/stream_3_governance/prod_minima_archive_admin/` | **Public `archive_*.raw.dat` mirror:** `exportraw`, integrity, nginx sketch, cron/RPC notes, retention; helper `tools/publish-archive-raw.sh`. |
